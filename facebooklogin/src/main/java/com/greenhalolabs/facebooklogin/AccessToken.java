...
public final class AccessToken implements Serializable {
    ...
    public static AccessToken createFromWebBundle(List<String> requestedPermissions,
                                                  Bundle bundle,
    ...
    private static AccessToken createNew(
        ...
        if (TextUtils.isEmpty(accessToken) || (expires == null)) {
    ...
    boolean isInvalid() {
        return TextUtils.isEmpty(this.token) || new Date().after(this.expires);
    }
    ...
    private static AccessToken createFromBundle(List<String> requestedPermissions, Bundle bundle,
        ...
        if (TextUtils.isEmpty(token) || (expires == null)) {
            return null;
        }
